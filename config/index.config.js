 ...
 * publicPath 前端打包后，静态资源路径前缀 生成效果如：//www.8ana.com/app.bundle.js
 * head 添加内容到模版的head中
 * baiduStat 百度统计
 * cnzzStat CNZZ统计
 * ga 谷歌分析
...
const config = {
  ...
  name: '8ana',
  describe: '8ana',
  keywords: '8ana,二次元导航,二次元主页',
  description: '8ana - 及时收录动漫网站及资讯、动画、漫画、音乐等内容，让您的二次元网络生活更简单精彩。',
  domain: 'https://www.8ana.com',
  port: 9999,
  publicPath: '',
  baiduStat: '',
  cnzzStat: '',
